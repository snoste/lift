...
\begin{enumerate}
	...
	\label{Req_FIFO}
	\item When a ship is waiting at a entry signal light, the light should switch to pass as soon as possible (with respect to functionality requirement \ref{Req_FIFO})
	\item After a ship has entered the sluice, the exit signal light on the other side should switch to pass as soon as possible (with respect to functionality requirement \ref{Req_FIFO})
\end{enumerate}
